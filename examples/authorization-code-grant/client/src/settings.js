...
// export const redirectUri = 'http://localhost:5174/oauth/callback';
...
// (which will "trade" auth code for an access token, and return it to the client)
// The one provided below is that of the sample Express server provided
export const appServerUrl = import.meta.env.VITE_APP_SERVER_URL;
// || 'http://localhost:5000';
